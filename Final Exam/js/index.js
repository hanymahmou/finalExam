...
// ? Function To Show And disblay Contact Form With Check Validation. 
...
function emailValidation() {
  return /^[A-Za-z0-9+_.-]+@(.+)$/.test(document.getElementById("emailInput").value
  );
}

function phoneValidation() {
  return /^[0-9]{2,10}$/.test(document.getElementById("phoneInput").value
  );
}
...
// ^= Function TO Get Meals And display it. 
...
// ^= Function TO Get Details Meal And display it. 
